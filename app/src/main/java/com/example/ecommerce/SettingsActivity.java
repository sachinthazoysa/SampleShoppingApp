...
public class SettingsActivity extends AppCompatActivity {
    ...
    private void userInfoSaved()
    {
        ...
        {
            Toast.makeText(SettingsActivity.this,"Phone number is mandatory", Toast.LENGTH_SHORT).show();
    ...
    private void uploadImage()
    {
        ...
        progressDialog.setMessage("Please wait,we are updating your account info");

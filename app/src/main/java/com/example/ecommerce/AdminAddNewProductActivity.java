...
public class AdminAddNewProductActivity extends AppCompatActivity {
    ...
    private String categoryName, Description, Price, Pname,saveCurrentDate, saveCurrenntTime;
    ...
    private void StoreProductInformation() {
        ...
        saveCurrenntTime = currentTime.format(calendar.getTime());

        productRandomKey = saveCurrentDate + saveCurrenntTime;

        final StorageReference filepath = ProductImagesRef.child(ImageUri.getLastPathSegment() +productRandomKey +".jpg");

        final UploadTask uploadTak= filepath.putFile(ImageUri);

        uploadTak.addOnFailureListener(new OnFailureListener() {
            @Override
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Task<Uri> urlTask= uploadTak.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    @Override
    ...
    private void SaveProductInfoToDatabase() {
        ...
        productMap.put("time",saveCurrenntTime);
